  ...
  <div class="page-content">
    <div class="d-flex align-items-center justify-content-between mb-3">
      ...
      <div class="d-flex gap-2">
        ...
        <button type="button" class="btn btn-primary rounded-3 px-4 shadow-sm" onclick="fsModalShow(event, {url: '{{ $nav_url }}/form_modal?n={{ $nav_id }}', title: 'Tambah Lokasi Baru'})">
              ...
              <table id="datatable-main" class="table table-hover table-striped align-middle w-100" style="font-size:13px">
                <thead>
                  <tr>
                    ...
                    --}}
                    <th class="text-start">ID Lokasi</th>
                    <th class="text-start">Nama Lokasi</th>
                    <th class="text-start">Tipe</th>
                    <th class="text-start">BPJS Nama</th>
                    <th class="text-start">BPJS Code</th>
