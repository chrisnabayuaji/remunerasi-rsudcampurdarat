  ...
  $(document).ready(function() {
        ...
        /* FITUR AKSI - Uncomment jika diperlukan
        {
          ...
          render: function(data, type, row, meta) {
            ...
            var html = '<div class="btn-group">' +
              ...
              '    <li><a class="dropdown-item py-2" href="javascript:void(0)" onclick="fsModalShow(event, {url: \'' + url_edit + '\', title: \'Ubah Data Lokasi\'})"><i class="fas fa-edit me-2"></i>Ubah Data</a></li>' +
    ...
    $('#btnSync').click(function() {
      Swal.fire({
        ...
        text: 'Apakah Anda yakin ingin melakukan sinkronisasi data lokasi dari SIMRS?',
        icon: 'question',
