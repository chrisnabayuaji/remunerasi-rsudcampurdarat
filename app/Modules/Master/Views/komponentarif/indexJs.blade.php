        ...
        },
        {
          ...
          render: function(data, type, row, meta) {
            ...
            var html = '<div class="btn-group">' +
              ...
              '    <li><a class="dropdown-item py-2" href="javascript:void(0)" onclick="fsModalShow(event, {url: \'' + url_edit + '\', title: \'Ubah Data Komponen Tarif\'})"><i class="fas fa-edit me-2"></i>Ubah Data</a></li>' +
